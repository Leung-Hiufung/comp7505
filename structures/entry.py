...
from structures.util import Hashable, object_to_byte_array, get_hash
...
class Entry(Hashable):
    ...
    def __gt__(self, other) -> bool:
        """
        Compares two Entry objects by their keys; returns true if self is greater
        than other. Relies on keys having __gt__ implemented.
        """
        return self.get_key() > other.get_key()
